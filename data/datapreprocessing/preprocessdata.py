...
if __name__ == "__main__":
    root = os.getcwd()
<<<<<<< Updated upstream:preprocessdata.py
...
=======
    df = pd.read_csv("../data/rock1edited2.csv")
    df2 = pd.read_csv("../data/rock2edited2.csv")
    df3 = pd.read_csv("../data/rockvalidedited.csv")

    df.dropna(how="all", axis=1, inplace=True)
    df2.dropna(how="all", axis=1, inplace=True)
>>>>>>> Stashed changes:datapreprocessing/preprocessdata.py
